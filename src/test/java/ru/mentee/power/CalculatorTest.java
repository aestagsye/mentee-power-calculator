...
class CalculatorTest {
    ...
    // 🔎 ВАША ЗАДАЧА: Найдите и исправьте ошибку в этом тесте! 🔎 исправил
    @Test
    ...
    void testSubtract() {
        ...
        assertEquals(-2, calculator.subtract(-5, -3)); //исправил
    }
    ...
    void testDivideByZero() {
        ...
        assertEquals("Деление на ноль", exception.getMessage());// Шаг 3: Проверьте, что сообщение в исключении содержит текст "Деление на ноль"
